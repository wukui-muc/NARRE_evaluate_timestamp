...
from .config import Health_and_Personal_Care_data_Config
from .config import Video_Games_data_Config
from .config import Automotive_data_Config
from .config import Tools_and_Home_data_Config
from .config import Movies_and_TV_data_Config
from .config import Amazon_Instant_Video_data_Config
from .config import Beauty_data_Config
from .config import Cell_Phones_and_Accessories_data_Config
